...
limited with ImGui.API;



pragma Elaborate_All( ImGui.API );
...
package imgui_impl_opengl3_h is
	...
	procedure ImGui_ImplOpenGL3_RenderDrawData (draw_data : access ImGui.API.ImDrawData)  -- imgui_impl_opengl3.h:27
	with Import => True,
	Convention => CPP,
